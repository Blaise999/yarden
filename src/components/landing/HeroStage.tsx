  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-6xl px-4 py-8 sm:px-6 sm:py-12 md:px-10 md:py-16">
        ...
        {/* Main grid layout */}
        <div className="grid gap-6 sm:gap-8 md:gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:gap-14">
          {/* Left: Copy */}
          <div ref={copyRef} className="space-y-4 sm:space-y-5 md:space-y-6 lg:space-y-7">
            {/* Tags */}
