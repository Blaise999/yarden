  ...
  return (
    <div className="space-y-2">
      ...
      <div className="flex items-start gap-3">
        <div
          className="relative w-24 h-24 rounded-xl bg-white/10 overflow-hidden ring-1 ring-white/10 cursor-pointer hover:ring-amber-400 transition"
        ...
        <div className="flex-1 space-y-2">
          ...
          <input
            ...
            className="w-full px-3 py-2 rounded-lg border border-white/10 text-sm focus:border-amber-400 focus:outline-none"
          />
          <button
            type="button"
            onClick={() => inputRef.current?.click()}
            className="px-3 py-1.5 bg-white/10 text-white/80 rounded-lg text-xs font-semibold hover:bg-white/15 transition"
          >
...
function InputField({
  ...
  return (
    <div>
      <label className="block text-xs text-white/50 uppercase tracking-wide mb-1">
        {label}
      </label>
      <Component
        type={type}
        ...
        rows={rows}
        className="w-full px-3 py-2 rounded-lg border border-white/10 bg-white/[0.03] text-white placeholder-white/30 text-sm focus:border-amber-400 focus:outline-none resize-none"
      />
    </div>
  );
}
  ...
  return (
    <div>
      ...
      <select
        value={value}
        onChange={(e) => onChange(e.target.value)}
        className="w-full px-3 py-2 rounded-lg border border-white/10 text-white text-sm focus:border-amber-400 focus:outline-none bg-[#0b0c14] [&>option]:text-black"
      >
        {options.map((opt) => (
...
function ReleaseEditor({
  ...
  return (
    <div className="border border-white/10 rounded-2xl overflow-hidden bg-white/[0.03]">
      <div
        className="p-4 flex items-center gap-4 cursor-pointer hover:bg-white/[0.06]"
        onClick={() => setExpanded(!expanded)}
      >
        <div className="w-16 h-16 rounded-xl bg-white/10 overflow-hidden ring-1 ring-white/10 shrink-0">
          {release.art && (
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2">
            ...
            {release.enabled ? (
              <span className="px-2 py-0.5 bg-emerald-400/15 text-emerald-300 rounded text-xs">
                Live
              </span>
            ) : (
        ...
        <span className="text-white/45">{expanded ? "▲" : "▼"}</span>
      </div>
      ...
      {expanded && (
        <div className="p-4 border-t border-white/10 space-y-4">
          ...
          <div className="space-y-2">
            ...
            {(release.tracklist || []).map((track: any, i: number) => (
              <div key={i} className="flex items-center gap-2">
                <span className="text-xs text-white/45 w-6">{i + 1}.</span>
                <input
                  value={track.title}
                  onChange={(e) => {
                  ...
                  className="flex-1 px-3 py-2 rounded-lg border border-white/10 text-sm focus:border-amber-400 focus:outline-none"
                ...
                <input
                  ...
                  className="w-32 px-3 py-2 rounded-lg border border-white/10 text-sm focus:border-amber-400 focus:outline-none"
                  placeholder="feat. ..."
                />
                <button
                  onClick={() => {
            ...
            <button
              ...
              className="px-3 py-2 bg-white/10 text-white/80 rounded-lg text-sm font-semibold hover:bg-white/15 transition"
            >
              + Add Track
            </button>
          </div>
          ...
          <div className="flex items-center justify-between pt-4 border-t border-white/10">
            ...
            <button
              onClick={onRemove}
              className="px-4 py-2 bg-red-500/10 text-red-400 rounded-lg text-sm font-semibold hover:bg-red-500/20 transition"
            >
              Delete Release
            </button>
          </div>
  ...
  return (
    <div className="border border-white/10 rounded-2xl overflow-hidden bg-white/[0.03]">
      <div
        ...
        onClick={() => setExpanded(!expanded)}
      >
        <div className="w-24 h-14 rounded-xl bg-white/10 overflow-hidden ring-1 ring-white/10 shrink-0">
          {thumbnailUrl && (
        ...
        <div className="p-4 border-t border-white/10 space-y-4">
          ...
          {youtubeId && (
            <div className="p-3 bg-emerald-400/10 rounded-lg">
              ...
              <p className="text-xs text-emerald-400 mt-1">ID: {youtubeId}</p>
              {thumbnailUrl && (
...
function ShowEditor({
  ...
  return (
    <div className="p-4 border border-white/10 rounded-xl bg-white/[0.03] space-y-4">
      {/* Poster */}
      <ImageUploader
        label="Show Poster"
    ...
    <div className="border border-white/10 rounded-2xl overflow-hidden bg-white/[0.03]">
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-sm text-white/50">{(item as any).price || ""}</p>
        </div>
        <span className="text-white/45">{expanded ? "▲" : "▼"}</span>
      </div>
...
export default function AdminPage() {
  ...
  if (view === "login") {
    return (
      <div className="min-h-screen bg-[#05060A] flex items-center justify-center p-4">
        <div className="bg-white/[0.03] rounded-3xl shadow-2xl p-8 w-full max-w-md">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-xl border-2 border-white/10 focus:border-amber-400 focus:outline-none transition-colors text-lg"
                placeholder="••••••••"
                required
                autoFocus
                disabled={loading}
            ...
            <button
              ...
              className="w-full py-4 bg-black text-amber-300 font-bold text-lg rounded-xl hover:bg-white/10 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-lg font-bold text-amber-300">The Yard</h1>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6">
        ...
        {tab === "passes" && (
          <>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
              <div className="bg-white/[0.03] rounded-2xl p-4 shadow-sm">
                <p className="text-xs text-white/50 uppercase tracking-wide">Total</p>
                <p className="text-2xl font-black text-white">{stats.total}</p>
              </div>
              <div className="bg-white/[0.03] rounded-2xl p-4 shadow-sm">
                <p className="text-xs text-white/50 uppercase tracking-wide">Angels</p>
                <p className="text-2xl font-black text-pink-500">{stats.angels}</p>
              </div>
              <div className="bg-white/[0.03] rounded-2xl p-4 shadow-sm">
                <p className="text-xs text-white/50 uppercase tracking-wide">Descendants</p>
                <p className="text-2xl font-black text-sky-400">{stats.descendants}</p>
              </div>
              <div className="bg-white/[0.03] rounded-2xl p-4 shadow-sm">
                <p className="text-xs text-white/50 uppercase tracking-wide">Today</p>
                <p className="text-2xl font-black text-emerald-400">{stats.todayCount}</p>
              </div>
            </div>
            ...
            <div className="flex justify-end mb-4">
              <button
                onClick={fetchPasses}
                disabled={loading}
                className="px-4 py-2 bg-amber-400 text-black rounded-lg text-sm font-bold hover:bg-amber-500 transition disabled:opacity-50"
              >
            ...
            {loading && passes.length === 0 ? (
              <div className="bg-white/[0.03] rounded-2xl p-12 text-center shadow-sm">
                <div className="w-10 h-10 border-4 border-amber-400 border-t-transparent rounded-full animate-spin mx-auto" />
                <p className="mt-4 text-white/50">Loading passes...</p>
              </div>
            ) : passes.length === 0 ? (
              <div className="bg-white/[0.03] rounded-2xl p-12 text-center shadow-sm">
                <span className="text-5xl">📭</span>
                <h3 className="mt-4 text-lg font-bold text-white">No Passes Yet</h3>
                ...
                <div className="overflow-x-auto">
                  <table className="w-full">
                    <thead className="bg-white/[0.03] border-b border-white/10">
                      <tr>
                        <th className="px-4 py-3 text-left text-xs font-bold text-white/50 uppercase">
                          Date
                        </th>
                        <th className="px-4 py-3 text-left text-xs font-bold text-white/50 uppercase">
                          Name
                    ...
                    <tbody className="divide-y divide-white/10">
                      {passes.map((pass) => (
                        <tr key={pass.id} className="hover:bg-white/[0.06] transition-colors">
                          ...
                          <td className="px-4 py-4">
                            <div className="flex gap-2">
                              <button
                                ...
                                className="px-3 py-1 bg-white/10 text-white/80 rounded text-xs font-semibold hover:bg-white/15 transition"
                              >
                                View
                              </button>
                              <button
                                onClick={() => downloadPass(pass)}
                                className="px-3 py-1 bg-amber-400/15 text-amber-300 rounded text-xs font-semibold hover:bg-amber-300 transition"
                              >
                                Download
                              </button>
                            </div>
        ...
        {tab === "releases" && (
          <div className="space-y-4">
            <div className="bg-white/[0.03] rounded-2xl p-5 shadow-sm flex flex-wrap items-center justify-between gap-3">
              <div>
                <h2 className="text-lg font-bold text-white">Music Releases</h2>
                <p className="text-sm text-white/50">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="px-4 py-2 bg-amber-400 text-black rounded-lg text-sm font-bold hover:bg-amber-500 transition"
                >
                  + Add Release
                </button>
                <button
                  onClick={saveCms}
                  disabled={cmsLoading}
                  className="px-4 py-2 bg-black text-amber-300 rounded-lg text-sm font-bold hover:bg-white/10 transition disabled:opacity-50"
                >
        ...
        {tab === "videos" && (
          <div className="space-y-4">
            <div className="bg-white/[0.03] rounded-2xl p-5 shadow-sm flex flex-wrap items-center justify-between gap-3">
              <div>
                <h2 className="text-lg font-bold text-white">Music Videos</h2>
                <p className="text-sm text-white/50">
            ...
            <div className="bg-sky-400/10 rounded-xl p-4">
        ...
        {tab === "tour" && (
          <div className="space-y-4">
            <div className="bg-white/[0.03] rounded-2xl p-5 shadow-sm flex flex-wrap items-center justify-between gap-3">
              <div>
                <h2 className="text-lg font-bold text-white">Tour Dates</h2>
                <p className="text-sm text-white/50">{cms.tour.shows.length} shows</p>
              </div>
              <div className="flex gap-2">
                <button
                  onClick={() => {
  ...
  posterAlt: "",
            ...
            <div className="bg-white/[0.03] rounded-2xl p-5 shadow-sm space-y-4">
              <h3 className="font-bold text-white">Tour Settings</h3>
        ...
        {tab === "merch" && (
          <div className="space-y-4">
            <div className="bg-white/[0.03] rounded-2xl p-5 shadow-sm flex flex-wrap items-center justify-between gap-3">
              <div>
                <h2 className="text-lg font-bold text-white">Merchandise</h2>
                <p className="text-sm text-white/50">{cms.store.merch.length} items</p>
              </div>
              <div className="flex gap-2">
                <button
                  onClick={() => {
        ...
        {tab === "newsletter" && (
          <div className="space-y-4">
            <div className="bg-white/[0.03] rounded-2xl p-5 shadow-sm flex flex-wrap items-center justify-between gap-3">
              <div>
                <h2 className="text-lg font-bold text-white">Newsletter & Press</h2>
                <p className="text-sm text-white/50">
            ...
            <div className="bg-white/[0.03] rounded-2xl p-5 shadow-sm space-y-4">
              <div className="flex items-center justify-between">
                <h3 className="font-bold text-white">Press Items</h3>
                <button
                  onClick={() => {
                  ...
                  className="px-3 py-1.5 bg-amber-400/15 text-amber-200 rounded-lg text-sm font-semibold hover:bg-amber-300 transition"
                >
                  + Add Press
                </button>
              </div>
            ...
            <div className="bg-white/[0.03] rounded-2xl p-5 shadow-sm space-y-4">
              <div className="flex items-center justify-between">
                <h3 className="font-bold text-white">Embed Videos</h3>
                <button
                  onClick={() => {
              ...
              <div className="space-y-3">
                {cms.newsletter.videos.map((video) => (
                  <div
                    key={video.id}
                    className="p-4 border border-white/10 rounded-xl space-y-3"
                  >
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      <InputField
                        label="Title"
                    ...
                    <div className="flex justify-end">
                      <button
                        ...
                        className="px-3 py-1.5 text-red-400 hover:bg-red-500/15 rounded-lg text-sm"
                      >
                        Remove
                      </button>
                    </div>
      ...
      {selectedPass && (
        ...
        >
          <div
            className="bg-white/[0.03] rounded-3xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-auto"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="p-6 border-b border-white/10 flex items-center justify-between sticky top-0 bg-white/[0.03] rounded-t-3xl">
              <div>
                <h3 className="text-xl font-black text-white">
                  {selectedPass.name}
                </h3>
                <p className="text-sm text-white/50 font-mono">{selectedPass.id}</p>
              </div>
              <button
                onClick={() => setSelectedPass(null)}
            ...
            <div className="p-6">
              {selectedPass.pngDataUrl ? (
                ...
                <div className="p-12 bg-white/10 rounded-2xl text-center">
                  <p className="text-white/50">No image available</p>
                </div>
              )}
            </div>

            <div className="p-6 bg-white/[0.03] rounded-b-3xl space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <p className="text-xs text-white/50 uppercase tracking-wide">Email</p>
                  <p className="text-sm font-medium text-white">{selectedPass.email}</p>
                </div>
                <div>
                  <p className="text-xs text-white/50 uppercase tracking-wide">Phone</p>
                  <p className="text-sm font-medium text-white">{selectedPass.phone}</p>
                </div>
              </div>

              <button
                onClick={() => downloadPass(selectedPass)}
                className="w-full py-4 bg-black text-amber-300 font-bold rounded-xl hover:bg-white/10 transition"
              >
                Download Pass Image
              </button>
            </div>
